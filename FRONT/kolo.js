...
export class Kolo{
    ...
    formaZaUnosUtakmice(host){
        ...
        dodajUtakmicu.onclick = () => {
            if(redosled>this.maxBrojUtakmica){
                ...
                let timAunos = document.querySelector(".timAinput").value;
                let timBunos = document.querySelector(".timBinput").value;
                let vremeUnos = document.querySelector(".vremeInput").value;
                let mestoUnos = document.querySelector(".mestoinput").value;
                let datumUnos = document.querySelector(".datumInput").value;
                ...
                if(timAunos=="" || timBunos=="" || vremeUnos=="" ||mestoUnos=="" || datumUnos =="")
                {
                    ...
                    let divovac = document.querySelector(".divZaUtakmice");

                let novaUtakmica = new Utakmica(divovac,redosled,timAunos,timBunos,mestoUnos,vremeUnos,datumUnos,this);
    ...
    formaDelegiranje(host){
       ...
       host.appendChild(delForma);
        ...
        {
            let sluzbenoLiceValue = document.querySelector(".sluzbenoLice").value;
            let uloga = selSL.value;
            let utakmicaValue = selUtakmica.value;
            let grad = document.querySelector(".gradSudije").value;
    ...
    vratiDivZaUtakmice()
    {
        let pom = document.querySelector(".divZaUtakmice");
        return pom;
    }
